...
\showit[3.5in]{pain-au-chocolat-layout}{Layout the dough to fit the cocolat batons}

\showit[3.5in]{pain-au-chocolat-first-fold}{Insert the first chocolate baton and fold}

\showit[3.5in]{pain-au-chocolat-second-fold}{Insert the second chocolate baton and fold}

\showit[3.5in]{pain-au-chocolat-roll-and-close}{Roll and press to close shut}
