...
\recipe[This is a simple and effective method for obtaining a smooth and gelatinous stock, perfect for binding sauces.]{Chicken Stock}
...
\recipe[This forgotten recipe from the great Escoffier is one of my all time favourites.]{Fond Blanc Ordinaire}
\label{rec:chicken-stock}
%\serves{4}
\preptime{14 hours}
%\cooktime[Chill time]{11/2 hours}
