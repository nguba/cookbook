...
\recipe[Superb sauce made from a whole bottle of cheap cooking wine.  This maginficent sauce is excellent with roast meats and game. Choose a wine that is high in tannins, such as a young bordeaux.]{Red Wine Sauce}
%\serves{4}
\preptime{15 minutes}
\cooktime{1 hour}
%\vegetarian
...
\recipe[Traditional Italian Rag\'u. A lot of recipes are way too liquid, preventing the enjoyment of the meat flavours. The method described here ensures it has the right consistency.]{Bolognese}
\label{rec:bolognese}
\serves{6}
\preptime{20 minutes}
\cooktime{1 hour}
